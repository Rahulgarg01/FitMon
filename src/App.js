import ladyImage from "./images.jpeg";
function App() {
  return (
    <div>
      <form action="#" id="profile-page" class="profile-edit">
        ...
        <div class="row-3">
          <div class="row-3-div-1">
            ...
            <img src={ladyImage} id="photo" alt="" />
          </div>
          <div class="row-3-div-2">
            <a href="#" id="link-1">Delete</a>
            <a href="#" id="link-2">Update</a>
          </div>
        </div>
        <div class="row-4">
          <label
            >Your bio <br /><span class="para-grey">
              Write a short introduction</span
            ></label
          >
        ...
        <div class="row-6">
          <label for="email">
            ...
            <span class="para-grey">
              Enter an alternative email if you'd like to</span
            >
          </label>
          <input
            type="email"
